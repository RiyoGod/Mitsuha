...
from Mitsuha.misc import _boot_
from Mitsuha.plugins.sudo.sudoers import sudoers_list
from Mitsuha.utils import bot_sys_stats
...
from Mitsuha.utils.inline.start import private_panel, start_panel
from Mitsuha.utils.inline.help import first_page
from config import BANNED_USERS, MITSUHA, START_IMG_URL
...
STICKERS = [
    ...
    "CAACAgIAAxkBAAICPGeCahvYHfTYIb_PHPVAQuYHf8YCAAJ0WgACJKiASgkR6SGIY_xqHgQ",
    "CAACAgQAAyEFAASTre2gAAImsmd_cR68JMrQLtlqYT9lHYY_p-A1AALACgAC0km4Uw993Zg0chHBHgQ",
    "CAACAgIAAxkBAAICPmeCakIdXfmBSJpTFKQSMHi2zNkeAAKVVgACS8AxSvtwBWEFdvaCHgQ",
